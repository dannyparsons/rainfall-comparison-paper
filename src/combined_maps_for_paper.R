...
plot_T_rainfall_map <- function(data, title, show_legend = FALSE) {
  ggplot() + 
...
plot_n_rainfall_map <- function(data, title, show_legend = FALSE) {
  ggplot() + 
...
plot_m_rain_rainfall_map <- function(data, title, show_legend = FALSE) {
  ggplot() + 
